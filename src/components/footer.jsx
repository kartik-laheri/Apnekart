    ...
    <div className="container-xxl">
      <div className="row justify-content-center justify-content-md-start">
        <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
          ...
          <div className='mb-3'><p><b>Address:</b> Nirma University, Ahmedabad</p> </div>
          <div className='mb-3'><p><b>Phone:</b>  <a className='footer-tel' href="tel:+919099885581">Call us at +91 9099885581</a></p> </div>
          <div className='mb-4'><p><b>Hours:</b>  From 9 A.M. To 7 P.M.</p> </div>
          <div className='mb-3'><p><b>Follow the developer</b></p> </div>
          <div className="socials d-flex gap-3">
          <Link to='https://instagram.com/kartik_laheri' id='footer-link' target='_blank' className='gap-3'>
          <BsInstagram />
          </Link>
          <Link to='https://twitter.com/karkarstic' id='footer-link' target='_blank' className='gap-3'>
          <BsTwitter />
          </Link>
          <Link className='gap-3' id='footer-link'>
          <BsFacebook />
          </Link>
          <Link to='https://github.com/kartik-laheri' id='footer-link' target='_blank' className='gap-3'>
          <BsGithub />
          </Link>
          </div>
        </div>
      ...
      <div className="row">
        ...
        <p className="text-center text-md-start">&copy;Developed by Demaze Intern in 2023</p>
        </div>
        <div className="col-12 col-md-6">
