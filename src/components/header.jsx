...
import logo from '../assets/images/apnekart.png'
      ...
      <div className="row">
        <div className="d-flex align-items-center justify-content-between d-none d-md-flex">
          ...
          <div className="col-md-2">
              <a href="tel:+919099885581"><Link className='links fs-4'><BiPhoneCall /></Link> +91 9099885581</a>
          </div>
          <div className="col-md">
            <Link className='links fs-4' target='_blank' onClick={() => window.open('mailto:apnekart@gmail.com')}><CiMail /></Link>
            <a href='mailto:apnekart@gmail.com' target='_blank'>apnekart@gmail.com</a>
          </div>
        </div>
        <div className="d-flex align-items-center  justify-content-between d-md-none">
          ...
          <a href="tel:+919099885581">Call us</a>
          </div>
          <div className="col-md-2 m-auto">
